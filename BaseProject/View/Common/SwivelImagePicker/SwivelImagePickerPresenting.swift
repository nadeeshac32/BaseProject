//
//  SwivelImagePickerPresenting.swift
//  Base Project
//
...
protocol SwivelImagePickerPresenting: SwivelImagePickerControllerDelegate {
    func presentImagePicker(completion: @escaping (UIImage?) -> Void)
}

/// Image picker to open image browsing.
extension SwivelImagePickerPresenting where Self: UIViewController {
    
    func presentImagePicker(completion: @escaping (UIImage?) -> Void) {
        completionBlock                                         = completion
        let imagePickerViewController                           = SwivelImagePickerController()
    ...
    func imagePickerControllerDidFinish(image: UIImage?, _ viewController: SwivelImagePickerController) {
