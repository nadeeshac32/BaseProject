...
/// Currently support two tab highlight annimations. `SwivelManuTabCell_Underline` and  `SwivelManuTabCell_Circle`.
/// You can add another animation like `SwivelManuTabCell_Underline` by subclassing `SwivelManuTabCell`.
class SwivelManuTab<ManyTabCell: SwivelManuTabCell>: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
