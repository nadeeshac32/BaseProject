...
struct NCCarouselConfig {
    ...
    var pageIndicatorPositon                            : NCPageControlPosition = .bottom
...
public class NCCarousel: UIView, UIScrollViewDelegate {
    public weak var delegate                            : NCCarouselDelegate?
    ...
    private var indicatorPosition                       : NCPageControlPosition = NCPageControlPosition.bottom
    
    /// Display views
    private var beforeMediaView                         : NCMultimediaView!
    private var currentMediaView                        : NCMultimediaView!
    private var afterMediaView                          : NCMultimediaView!
    ...
    fileprivate func initSubViews() {
        ...
        beforeMediaView                                 = NCMultimediaView(frame: self.bounds)
        currentMediaView                                = NCMultimediaView(frame: self.bounds)
        afterMediaView                                  = NCMultimediaView(frame: self.bounds)
    ...
    @objc fileprivate func didSelectMediaView(_ sender: UITapGestureRecognizer) {
        if mediaUrls.count > 0 && mediaUrls.count > currentIndex {
    ...
    func configCarousel(configs: NCCarouselConfig = NCCarouselConfig(), mediaUrls: [String] = [], describedTitle: [String] = []) {
    ...
    fileprivate func copyAsset(from: NCMultimediaView, to: NCMultimediaView) {
