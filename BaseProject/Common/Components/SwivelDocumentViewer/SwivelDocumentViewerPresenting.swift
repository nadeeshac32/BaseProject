//
//  SwivelDocumentViewerPresenting.swift
//  Base Project
//
...
protocol SwivelDocumentViewerPresenting: UIDocumentInteractionControllerDelegate {
...
/// Implementation of  `SwivelDocumentViewerPresenting`. Enables ViewControllers to display documents.
extension SwivelDocumentViewerPresenting where Self: UIViewController {
