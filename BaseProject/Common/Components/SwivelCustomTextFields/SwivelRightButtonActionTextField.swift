//
//  SwivelRightButtonActionTextField.swift
//  Base Project
//
...
/// Text field extended from `SwivelNormalTextField` that has custom action for right button which appears while typing.
@IBDesignable open class SwivelRightButtonActionTextField: SwivelNormalTextField {
