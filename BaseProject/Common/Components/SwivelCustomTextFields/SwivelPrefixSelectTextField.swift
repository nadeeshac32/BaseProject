//
//  SwivelPrefixSelectTextField.swift
//  Base Project
//
...
protocol DropDownPresentable: class {
    func showCountryPickerDropDown(tf: SwivelPrefixSelectTextField, cpv: CountryPickerView)
    func showCountryPickerDropDown(tf: SwivelUsernameTextField, cpv: CountryPickerView)
}
...
/// Text field extended from `SwivelNormalTextField` that show a dropdown when tapped. Dropdown can be configured.
@IBDesignable open class SwivelPrefixSelectTextField: SwivelNormalTextField, CountryPickerViewDelegate, CountryPickerViewDataSource {
