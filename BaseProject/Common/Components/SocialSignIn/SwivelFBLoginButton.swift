...
class SwivelFBLoginButton: BaseButton {
    
    private weak var responsibleViewController  : UIViewController!
    var loginCompletionHandler                  : ((SwivelFBLoginButton, Result<LoginManagerLoginResult, Error>) -> Void)?
    var loginCancleHandler                      : ((SwivelFBLoginButton) -> Void)?
    ...
    @objc private func touchUpInside(sender: SwivelFBLoginButton) {
